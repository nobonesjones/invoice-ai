...
export const DUE_DATE_OPTIONS: DueDateOption[] = [
	...
	{ label: "Due in 7 days", type: "net_7", days: 7 },
	{ label: "Due in 14 days", type: "net_14", days: 14 },
	{ label: "Due in 30 days", type: "net_30", days: 30 },
	{ label: "Custom", type: "custom" },
];

const SetDueDateSheet = forwardRef<BottomSheetModal, SetDueDateSheetProps>(
	(
		{ currentDueDateType, currentCustomDueDate, onSelectDueDate, onClose },
		ref,
	) => {
