...
interface InvoiceOverviewDatesSheetProps { 
...
const InvoiceOverviewDatesSheet = forwardRef<BottomSheetModal, InvoiceOverviewDatesSheetProps>(
	(
...
export default InvoiceOverviewDatesSheet; 
