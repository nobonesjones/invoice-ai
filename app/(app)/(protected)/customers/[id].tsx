...
const initialMockCustomers: Customer[] = [
  { id: '1', name: 'Alice Wonderland', email: 'alice@example.com', phone: '123-456-7890', lastActivity: { amount: 150, status: 'Paid', date: '5 May' }, lastContacted: '1d ago' },
  { id: '2', name: 'Bob The Builder', email: 'bob@example.com', phone: '234-567-8901', lastActivity: { amount: 75, status: 'Due', date: '28 Apr' } },
  { id: '3', name: 'Charlie Chaplin', email: 'charlie@example.com', phone: '345-678-9012', lastActivity: { amount: 300, status: 'Draft', date: '10 May' }, lastContacted: '5h ago' },
...
const mockTimelineEvents = [
  { id: '1', type: 'system', message: 'Invoice #004 · Sent · 5 May', date: '2025-05-05' },
  { id: '2', type: 'status', message: 'Paid · 7 May 2025', date: '2025-05-07' },
  { id: '3', type: 'action', message: 'Created from AI assistant', date: '2025-05-04' },
  { id: '4', type: 'date_separator', date: 'Monday, May 6' },
  { id: '5', type: 'system', message: 'Invoice #003 · Draft · 3 May', date: '2025-05-03' },
];

// Simplified CustomHeaderTitle for Avatar and Name only
const CustomHeaderTitle = ({ customerName }: { customerName: string | undefined }) => {
...
export default function CustomerDetailScreen() {
  ...
  console.log('[CustomerDetailScreen] Found customer:', JSON.stringify(customer, null, 2));
    ...
    <View style={styles.container}>
      <Stack.Screen 
        options={{
          ...
          headerTitle: () => <CustomHeaderTitle customerName={customer?.name} />,
          headerLeft: () => (
            <Pressable 
              onPress={() => {
                console.log('Attempting to navigate to /customers/ with router.push');
          ...
          headerRight: () => {
            if (!customer || !customer.lastActivity || customer.lastActivity.status !== 'Due' || !(customer.lastActivity.amount > 0)) {
              return null; // No pill if not outstanding
            }
            console.log('[headerRight] Rendering pill for customer:', customer.name);
            return (
              <View style={[styles.outstandingPill, { marginRight: Platform.OS === 'ios' ? 10 : 16 }]}>
      ...
      <Pressable style={styles.fab} onPress={() => console.log('New Invoice for customer:', id)}>
