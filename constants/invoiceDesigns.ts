...
export const INVOICE_DESIGNS: InvoiceDesign[] = [
  ...
  { id: 'wave', name: 'wave', displayName: 'Wave', description: 'Gradient header with a wave edge', colorScheme: { ...base, primary: '#7C3AED', accent: '#A78BFA' } },
  { id: 'classic', name: 'classic', displayName: 'Classic', description: 'Centred letterhead, boxed table', colorScheme: { ...base, primary: '#1E3A8A', accent: '#1E3A8A' } },
  ...
  { id: 'ledger', name: 'ledger', displayName: 'Ledger', description: 'Serif, double rules, ruled grid', colorScheme: { ...base, primary: '#14532D', accent: '#14532D' } },
];
