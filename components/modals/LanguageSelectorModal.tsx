...
export const LanguageSelectorModal: React.FC<LanguageSelectorModalProps> = ({
	...
	return (
		<Modal
			...
			useNativeDriver // Use native driver for smoother animations
			hideModalContentWhileAnimating // Improve performance
		>
					...
					<View style={styles.storageContentContainer}>
						...
						<View
							style={[
								...
								{ backgroundColor: theme.border, marginBottom: 24 },
							]}
						>
							<View
								style={[
									styles.progressBarFill,
									{ width: "25%", backgroundColor: theme.primary },
								]}
							/>
						</View>
